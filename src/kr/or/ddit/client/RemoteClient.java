...
public class RemoteClient {
	public static void main(String[] args){
		...
		try {
			...
			//    사용할 객체를 불러온다.
			Registry reg = LocateRegistry.getRegistry("192.168.205.11", 8888);
			RemoteInterface clientInf = (RemoteInterface) reg.lookup("server");
			
			// 이제부터는 불러온 객체의 메서드를 호출해서 사용할 수 있다.
			int a = clientInf.doRemotePrint("방가방가");
			...
			files[0] = new File("e:/D_Other/sisi.jpg");
			files[1] = new File("e:/D_Other/sisisi.jpg");
